...
parser.add_argument(
    "--limit", dest="limit", help="How many top results to return", default=sample_limit
)
parser.add_argument(
    "--word_counts",
    dest="word_counts",
    help="Mapping of words to counts",
    default=sample_word_counts,
)
...
results = get_results(
    prefix=args.prefix, word_counts=args.word_counts, limit=args.limit
)
